...
export default function Contas() {
  ...
  return (
    <div style={{ animation: 'fadeIn .4s ease' }}>
          ...
          {contas.map(c => {
            ...
            return (
              <div key={c.Id_Conta} className="glass-card" style={{ padding: 0, overflow: 'hidden' }}>
                {/* Card Top Band */}
                <div style={{
                  height: 6, background: `linear-gradient(90deg, ${c.Cor_Hex}, ${c.Cor_Hex}88)`,
                }} />
      ...
      ) : <EmptyState icon={CreditCard} title="Sem contas" description="Adicione sua primeira conta ou cartão" action={{ label: 'Adicionar', onClick: openCreate }} />}
